...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Raúl Martínez Pardos | Conceptos y nombres memorables" },
      { name: "description", content: "Desarrollo conceptos y nombres para proyectos que no quieren pasar desapercibidos." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Raúl Martínez Pardos | Conceptos y nombres memorables" },
      { property: "og:description", content: "Desarrollo conceptos y nombres para proyectos que no quieren pasar desapercibidos." },
