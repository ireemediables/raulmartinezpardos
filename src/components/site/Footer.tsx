  ...
  return (
    <footer className="mt-20 border-t border-[color:var(--rule)] sm:mt-28 md:mt-32">
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-5 py-10 text-sm text-muted-foreground sm:gap-3 sm:px-6 sm:py-12 md:flex-row md:items-center md:justify-between md:px-10">
        <p>
          <a href={`mailto:${contacto.email}`} className="rounded-sm transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[color:var(--background)]">
            {contacto.email}
          </a>
        </p>
